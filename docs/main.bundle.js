            ...
            _this.user2.subscribe(function (val2) {
                ...
                val.forEach(function (a) {
                    if (a.email === em) {
                        ...
                        _this.name = _this.info.first_name + ' ' + _this.info.app + ' ' + _this.info.apm;
                    }
                });
            });
        });
